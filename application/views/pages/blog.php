					...
					<?php foreach($blogs as $blog): ?>
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="fh5co-blog animate-box">
								<a href="<?php echo base_url('blog/'.$blog['slug']); ?>"><?php echo img(base_url('uploads/blog/'.$blog['img'])); ?></a>
								<div class="blog-text">
									<div class="prod-title">
										<h3><a href="<?php echo base_url('blog/'.$blog['slug']); ?>"><?php echo $blog['title']; ?></a></h3>
										<span class="posted_by"><?php echo $blog['date']; ?></span>
										<p><?php echo $blog['snippet'],'...'; ?></p>
										<p><a href="<?php echo base_url('blog/'.$blog['slug']); ?>">Learn More...</a></p>
									</div>
								</div> 
							</div>
						</div>

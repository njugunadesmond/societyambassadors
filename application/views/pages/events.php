			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Participate</h3>
						<p style="text-transform: capitalize;">Upcoming missions, team buildings, anniversaries and hikes</p>
					</div>
				</div>
			</div>
			<div class="container">
					...
					<?php foreach($events as $event): ?>
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="fh5co-blog animate-box">
								<a href="<?php echo base_url('events/'.$event['slug']); ?>"><?php echo img(base_url('uploads/events/'.$event['img'])); ?></a>
								<div class="blog-text">

        <title><?php echo ucwords('create blog') ;?> | Shoppy Store</title>
    </head>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Add Blog</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-body">
                                                                <div class="form-group">
                                                                    <label class="control-label" for="blog_photo">Blog Photo</label>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="blog_title" style="text-transform: capitalize;" class="form-control" placeholder="Blog Title" value="<?php echo set_value('blog_title')?>"> </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label" for="linkedin_add">About</label>
                                                                    <div class="input-group">
                                                                        <textarea name="blog_about" data-provide="markdown" rows="10" data-error-container="#editor_error" title="expand"></textarea> 

...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Login | Society Ambassadors " name="description" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="<?php echo base_url(); ?>">
                <h1>Society Ambassadors</h1>
                <!-- <img src="<?php echo base_url('public/admin/pages/img/logo-big-white.png'); ?>" style="height: 17px;" alt="" />  -->
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label visible-ie8 visible-ie9" for="identity">Email/Username</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Email/Username" name="identity" value="" id="identity" /> </div>
                <div class="form-group">
                ...
                <div class="form-actions">
                    <button type="submit" name="submit" class="btn red btn-block uppercase">Login</button>
                </div>
                <div class="form-actions">
                    <div class="pull-left">
